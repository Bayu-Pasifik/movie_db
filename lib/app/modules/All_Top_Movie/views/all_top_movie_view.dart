...
class AllTopMovieView extends GetView<AllTopMovieController> {
  const AllTopMovieView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    final userData = Get.arguments;
    return Scaffold(
      appBar: AppBar(title: Text("All Top Movie")),
      body: GetBuilder<AllTopMovieController>(
        builder: (c) {
